...
For the guide to update your firmware, see [firmware-update-guide.md](firmware-update-guide.md)

Here is a printable version of the booklet: [booklet-v1.pdf](booklet-v1.pdf)
